...
void TestClass::TestRand()
{
...

	{
		...
		Check(DoubleCompare(counts[1]/counts[0],1.5,0.01));
	}

	{
		...
		Check(DoubleCompare(counts[1]/counts[0],7./3.,0.01));
	}

	{
		...
		Check(DoubleCompare(counts[1]/counts[0],5.,0.01));
		Check(DoubleCompare(counts[2]/counts[1],0.8,0.01));
	}

	{
		...
		Check(DoubleCompare(counts[1]/counts[0],7./4.,0.01));
		Check(DoubleCompare(counts[2]/counts[1],1./7.,0.01));
	}
}
...
void TestClass::TestSubSequence()
{
	{
