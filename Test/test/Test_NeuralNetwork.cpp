...
Test_NeuralNetwork::Test_NeuralNetwork(void)
{
}
...
void Test_NeuralNetwork::RunTest()
{
...
void Test_NeuralNetwork::RunTest_PerceptronNetwork()
{
	{
...
void Test_NeuralNetwork::RunTest_ADALINENetwork()
{
	double a1[3]={1,-1,-1},
		a2[3]={1,1,-1},
		tt1[1]={-1},
...
void Test_NeuralNetwork::RunTest_MultiNetwork()
{
	double a1[1]={1},
		tt1[1]={g(1)},
		w1_1[1]={-0.27},
...
void Test_NeuralNetwork::RunTest_CompetitiveNetwork()
{
