...
// Test_Relation::Test_Relation(void)
// {
// 
// }
// 
...
// 	Test_RelationResonance();
// 
// 	iCerebrum::KillInstance();
// }
// 
// void Test_Relation::Test_GetString()
// {
...
// }
// 
// void Test_Relation::Test_RelationLeafSatisfy()
// {
// 	//InterTableSatisfyRelation
// 	{
// 		shared_ptr<iConcept> san=SimpleConcept("三");
...
// 		interTable->Add(yu,er);
// 		
// 		ASSERT_TRUE(leaf1->InterTableSatisfyRelation(interTable));
// 	}
// 
// 	//AddConstraint
// 	{
...
// 		interTable->Add(yu,san2);
// 
// 		ASSERT_TRUE(leaf1->InterTableSatisfyRelation(interTable)==false);
// 	}
// 	//InterTableSatisfyRelation
// 	{
// 		shared_ptr<iConcept> san=SimpleConcept("三");
...
// }
// 
// void Test_Relation::Test_RelationNodeSatisfy()
// {
// 	//"三大于二" and "二大于一"
// 	{
// 		shared_ptr<iConcept> san=SimpleConcept("三");
...
// 
// 		ASSERT_TRUE(relation->InterTableSatisfyRelation(interTable));
// 
// 	}
// 
// 	//"三大于二" and "二小于一"
...
// 		shared_ptr<RelationNode> relation=RelationSample1();
// 
// 		ASSERT_TRUE(relation->InterTableSatisfyRelation(interTable)==false);
// 
// 	}
// 
// 	//"三大于二" and "二大于一" with perturbation
...
// }
// 
// shared_ptr<LogicSystem::RelationNode> Test_Relation::RelationSample1()
// {
// 	shared_ptr<Arb> arb1=Arb::Create();
// 	shared_ptr<Sym> s1(new Sym(SimpleConcept("大")));
// 	shared_ptr<Sym> s2(new Sym(SimpleConcept("于")));
...
// }
// 
// shared_ptr<LogicSystem::RelationNode> Test_Relation::RelationSample2()
// {
// 	shared_ptr<Arb> arb1=Arb::Create();
// 	shared_ptr<Sym> s1(new Sym(SimpleConcept("大")));
// 	shared_ptr<Sym> s2(new Sym(SimpleConcept("于")));
...
// }
// 
// void Test_Relation::Test_RelationResonance()
// {
// 	shared_ptr<RelationNode> conditionRel(new RelationNode());
// 	shared_ptr<RelationLeaf> resultRel(new RelationLeaf());
...
// }
// 
// void Test_Relation::RelationPair( shared_ptr<RelationNode> condition,shared_ptr<RelationLeaf> result )
// {
// 	//Create condition
// 	shared_ptr<Arb> arb1=Arb::Create();
// 	shared_ptr<Sym> s1(new Sym(SimpleConcept("大")));
