...
namespace NeuralNetwork
{
	...
	private:
		void SetTrainImp(const shared_ptr<MultilayerNetworkTrainImp> val){_trainImp=val;}
	...
	public:
		...
		//true for Neuron Changed, false for not
	...
	private:
		...
		void train_MultiNetwork::ComputeSensitivity(const MyNeurons::const_reverse_iterator& neo_backward, 
			...
			shared_ptr<iDataArray> s_m, shared_ptr<iDataArray>& s_m_next, shared_ptr<Math::Matrix>& mat_next) const;	
